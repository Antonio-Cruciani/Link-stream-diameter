        ...
        for idx, i in enumerate(num_times):
            ...
            with open(input_path, "r") as f:
                for row in f:
                    ...
                    print('\n')
                    print('EAT iFUB Graph ' + graph_name, flush=True)
                    print('EAT iFUB Graph ' + graph_name + ' Dummy node: ' + str(dummy_node), flush=True)
                    print('EAT iFUB Graph ' + graph_name + ' is_directed: ' + str(is_directed), flush=True)
