...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="Compute iFUB Shortest Path for all graps whose paths are in file"
        ...
        for idx, i in enumerate(num_times):
            ...
            with open(input_path, "r") as f:
                for row in f:
                    ...
                    print('\n')
                    print('SP iFUB Graph ' + graph_name, flush=True)
                    print('SP iFUB Graph ' + graph_name + ' Dummy node: ' + str(dummy_node), flush=True)
                    print('SP iFUB Graph ' + graph_name + ' is_directed: ' + str(is_directed), flush=True)
                    ...
                    print('S3 SP NumTimes=' + str(i) + ' NumHubs=' + str(num_hub[k]) + ' ' + graph_name +
